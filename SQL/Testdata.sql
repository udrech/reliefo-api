...
INSERT INTO customers (lastname, firstname, address, city, zipcode, mobile, created_at, updated_at)
VALUES ('Dreher', 'Urs', 'Warteggstrasse 10', 'Rorschacherberg', '9404', '079 295 83 06', NOW(), NOW());
INSERT INTO customers (lastname, firstname, address, city, zipcode, mobile, created_at, updated_at)
VALUES ('Oettli', 'Sabina', 'Warteggstrasse 10', 'Rorschacherberg', '9404', '079 285 60 11', NOW(), NOW());

-- TRUNCATE TABLE therapies;
INSERT INTO therapies (name, description, duration, price, valid_until, created_at, updated_at)
VALUES ('Klassische Massage', 'Massage nach Wunsch - ganzer Körper, Rücken, etc.', 60, 90, '2026-12-31 23:00:00', NOW(), NOW());
